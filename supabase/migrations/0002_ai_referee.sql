-- =========================================================
-- VERITAS — AI referee (Grok) migration
--
...
-- 3. Set its secrets (pick your own AI_REFEREE_SECRET — any
--    random string, it just has to match what you paste below):
--      npx supabase secrets set XAI_API_KEY=... AI_REFEREE_SECRET=... --project-ref <PROJECT_REF>
